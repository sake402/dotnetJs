...
//    sealed class CollectionExpressionToReadOnlySpanAssignmentSyntaxEmitter : SyntaxEmitter<CollectionExpressionSyntax>
//    {
...
//        public override bool TryEmit(CollectionExpressionSyntax node, TranslatorSyntaxVisitor visitor)
//        {
//            var rhsType = (INamedTypeSymbol?)visitor.Global.ResolveSymbol(visitor.GetExpressionReturnSymbol(node), visitor)?.GetTypeSymbol();
//            if (rhsType == null)
//                return false;
//            return lhsType.IsType("System.ReadOnlySpan<>", true) &&
//                ((rhsType.IsArray(out var elementType) && SymbolEqualityComparer.Default.Equals(elementType, lhsType.TypeArguments[0])) || (rhsType.IsType("System.ReadOnlySpan<>", true) && SymbolEqualityComparer.Default.Equals(rhsType.TypeArguments[0], lhsType.TypeArguments[0])));
